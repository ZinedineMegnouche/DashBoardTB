...
require_once 'adminDashboard.php';
    ...
    <?php
        ...
        //photo
        echo '<label for= "restraintMode">Mode restraint: </label><input id= "restraintMode" type="checkbox" ' . isRestraintCheck($idEmploye) . '></br>';
    ...
    <?php
        if (isset($_POST["btnSubmit"]))
        {
            if (isset($_REQUEST['name']) && isset($_REQUEST['mail']) && isset($_REQUEST['phone']) && isset($_REQUEST['adress']) && isset($_REQUEST['poste']) && isset($_REQUEST['typeContrat']) && isset($_REQUEST['dateSignature']))
            {
                ...
                modifyEmploye($idTB,$name,$mail,$phone,$typeContrat,$adress,$dateSignature,$poste);
